...
public class PDSTallerPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PDSTaller";
	...
	private PDSTallerPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PDSTallerPersistentManager();
		}
