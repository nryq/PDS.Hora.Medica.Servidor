...
public class Reporte2DAO {
	...
	public static Reporte2 loadReporte2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Reporte2) session.load(orm.Reporte2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reporte2 getReporte2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Reporte2) session.get(orm.Reporte2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reporte2 loadReporte2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Reporte2) session.load(orm.Reporte2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reporte2 getReporte2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Reporte2) session.get(orm.Reporte2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reporte2 createReporte2() {
		return new orm.Reporte2();
	}
	
	public static boolean save(orm.Reporte2 reporte2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(reporte2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Reporte2 reporte2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(reporte2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Reporte2 reporte2)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(orm.Reporte2 reporte2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(reporte2.getDirector() != null) {
				reporte2.getDirector().setReporte2(null);
			}
	...
	public static boolean refresh(orm.Reporte2 reporte2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(reporte2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Reporte2 reporte2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(reporte2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
