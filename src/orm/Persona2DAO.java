...
public class Persona2DAO {
	...
	public static Persona2 loadPersona2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Persona2) session.load(orm.Persona2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Persona2 getPersona2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Persona2) session.get(orm.Persona2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Persona2 loadPersona2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Persona2) session.load(orm.Persona2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Persona2 getPersona2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Persona2) session.get(orm.Persona2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Persona2 createPersona2() {
		return new orm.Persona2();
	}
	
	public static boolean save(orm.Persona2 persona2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(persona2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Persona2 persona2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(persona2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Persona2 persona2)throws PersistentException {
		try {
			...
			orm.Reserva2[] lReserva2s = persona2.reserva2.toArray();
	...
	public static boolean deleteAndDissociate(orm.Persona2 persona2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(persona2.getPaciente2() != null) {
				persona2.getPaciente2().setPersona(null);
			}
	...
	public static boolean refresh(orm.Persona2 persona2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(persona2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Persona2 persona2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(persona2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
