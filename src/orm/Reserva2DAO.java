...
public class Reserva2DAO {
	...
	public static Reserva2 loadReserva2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Reserva2) session.load(orm.Reserva2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reserva2 getReserva2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Reserva2) session.get(orm.Reserva2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reserva2 loadReserva2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Reserva2) session.load(orm.Reserva2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reserva2 getReserva2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Reserva2) session.get(orm.Reserva2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Reserva2 createReserva2() {
		return new orm.Reserva2();
	}
	
	public static boolean save(orm.Reserva2 reserva2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(reserva2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Reserva2 reserva2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(reserva2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Reserva2 reserva2)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(orm.Reserva2 reserva2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(reserva2.getPersona() != null) {
				reserva2.getPersona().reserva2.remove(reserva2);
			}
	...
	public static boolean refresh(orm.Reserva2 reserva2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(reserva2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Reserva2 reserva2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(reserva2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
