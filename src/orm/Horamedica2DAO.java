...
public class Horamedica2DAO {
	...
	public static Horamedica2 loadHoramedica2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Horamedica2) session.load(orm.Horamedica2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Horamedica2 getHoramedica2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Horamedica2) session.get(orm.Horamedica2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Horamedica2 loadHoramedica2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Horamedica2) session.load(orm.Horamedica2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Horamedica2 getHoramedica2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Horamedica2) session.get(orm.Horamedica2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Horamedica2 createHoramedica2() {
		return new orm.Horamedica2();
	}
	
	public static boolean save(orm.Horamedica2 horamedica2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(horamedica2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Horamedica2 horamedica2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(horamedica2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Horamedica2 horamedica2)throws PersistentException {
		try {
			...
			orm.Paciente_hora[] lPaciente_horas = horamedica2.paciente_hora.toArray();
			for(int i = 0; i < lPaciente_horas.length; i++) {
				lPaciente_horas[i].setHoramedica(null);
			}
			orm.Reserva2[] lReserva2s = horamedica2.reserva2.toArray();
	...
	public static boolean deleteAndDissociate(orm.Horamedica2 horamedica2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(horamedica2.getBox() != null) {
				horamedica2.getBox().horamedica2.remove(horamedica2);
			}
	...
	public static boolean refresh(orm.Horamedica2 horamedica2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(horamedica2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Horamedica2 horamedica2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(horamedica2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
