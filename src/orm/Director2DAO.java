...
public class Director2DAO {
	...
	public static Director2 loadDirector2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Director2) session.load(orm.Director2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Director2 getDirector2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Director2) session.get(orm.Director2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Director2 loadDirector2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Director2) session.load(orm.Director2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Director2 getDirector2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Director2) session.get(orm.Director2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Director2 createDirector2() {
		return new orm.Director2();
	}
	
	public static boolean save(orm.Director2 director2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(director2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Director2 director2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(director2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Director2 director2)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(orm.Director2 director2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(director2.getPersona() != null) {
				director2.getPersona().setDirector2(null);
			}
	...
	public static boolean refresh(orm.Director2 director2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(director2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Director2 director2) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(director2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
