...
public class Paciente_horaDAO {
	...
	public static Paciente_hora loadPaciente_horaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Paciente_hora) session.load(orm.Paciente_hora.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Paciente_hora getPaciente_horaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Paciente_hora) session.get(orm.Paciente_hora.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Paciente_hora loadPaciente_horaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Paciente_hora) session.load(orm.Paciente_hora.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Paciente_hora getPaciente_horaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Paciente_hora) session.get(orm.Paciente_hora.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Paciente_hora createPaciente_hora() {
		return new orm.Paciente_hora();
	}
	
	public static boolean save(orm.Paciente_hora paciente_hora) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(paciente_hora);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Paciente_hora paciente_hora) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(paciente_hora);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Paciente_hora paciente_hora)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(orm.Paciente_hora paciente_hora, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(paciente_hora.getPaciente() != null) {
				paciente_hora.getPaciente().paciente_hora.remove(paciente_hora);
			}
	...
	public static boolean refresh(orm.Paciente_hora paciente_hora) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(paciente_hora);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Paciente_hora paciente_hora) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(paciente_hora);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
