...
public class EspecialidadDAO {
	...
	public static boolean save(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().saveObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().deleteObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Especialidad especialidad)throws PersistentException {
		try {
			orm.Medico2[] lMedico2s = especialidad.medico2.toArray();
	...
	public static boolean refresh(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().refresh(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.PDSTallerPersistentManager.instance().getSession().evict(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
