...
public class Medico2DAO {
	...
	public static Medico2 loadMedico2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Medico2) session.load(model.Medico2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Medico2 getMedico2ByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Medico2) session.get(model.Medico2.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Medico2 loadMedico2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Medico2) session.load(model.Medico2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Medico2 getMedico2ByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Medico2) session.get(model.Medico2.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Medico2 createMedico2() {
		return new model.Medico2();
	}
	
	public static boolean save(model.Medico2 medico2) throws PersistentException {
		try {
			model.PDSTallerPersistentManager.instance().saveObject(medico2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(model.Medico2 medico2) throws PersistentException {
		try {
			model.PDSTallerPersistentManager.instance().deleteObject(medico2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(model.Medico2 medico2)throws PersistentException {
		try {
			...
			model.Horamedica2[] lHoramedica2s = medico2.horamedica2.toArray();
	...
	public static boolean deleteAndDissociate(model.Medico2 medico2, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(medico2.getPersona() != null) {
				medico2.getPersona().setMedico2(null);
			}
	...
	public static boolean refresh(model.Medico2 medico2) throws PersistentException {
		try {
			model.PDSTallerPersistentManager.instance().getSession().refresh(medico2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(model.Medico2 medico2) throws PersistentException {
		try {
			model.PDSTallerPersistentManager.instance().getSession().evict(medico2);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
